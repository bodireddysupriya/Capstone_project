...
@Signup
  Scenario Outline: To check the Creating New Customer Account page with valid and invalid data  
    ...
    Examples:  
      ...
      | Bodireddy    | Supriya    | 	qkjbqke			         | Pass@1234   | Pass@1234	     | bodredysupriya1234@gmail.com    |Thank you for registering with Main Website Store.   | Please enter a valid email address (Ex: johndoe@domain.com).| 
